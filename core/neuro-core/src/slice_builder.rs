...
use crate::{SliceSpec, InterpolationMethod, BorderMode, Volume};
    ...
    pub fn build_with_volumes(self, volumes: &[&dyn Volume]) -> SliceSpec {
        ...
        let pix_size_mm = match self.pixel_strategy {
            ...
            PixelStrategy::ScreenOptimal => {
                self.calculate_screen_optimal_size()
            },
...
mod tests {
    ...
    fn test_pixel_strategies() {
        ...
        let pixel_size_min = (spec_min.u_mm[0].powi(2) + spec_min.u_mm[1].powi(2) + spec_min.u_mm[2].powi(2)).sqrt();
        ...
        let pixel_size_max = (spec_max.u_mm[0].powi(2) + spec_max.u_mm[1].powi(2) + spec_max.u_mm[2].powi(2)).sqrt();
    ...
    fn test_explicit_pixel_size() {
        ...
        let pixel_size = (spec.u_mm[0].powi(2) + spec.u_mm[1].powi(2) + spec.u_mm[2].powi(2)).sqrt();
