...
impl CpuEllipsoidRenderer {
    ...
    pub fn render_slice(
        ...
        let world_to_ellipsoid = Matrix4::new(
            world_to_ellipsoid_f64[(0,0)] as f32, world_to_ellipsoid_f64[(0,1)] as f32, world_to_ellipsoid_f64[(0,2)] as f32, world_to_ellipsoid_f64[(0,3)] as f32,
            world_to_ellipsoid_f64[(1,0)] as f32, world_to_ellipsoid_f64[(1,1)] as f32, world_to_ellipsoid_f64[(1,2)] as f32, world_to_ellipsoid_f64[(1,3)] as f32,
            world_to_ellipsoid_f64[(2,0)] as f32, world_to_ellipsoid_f64[(2,1)] as f32, world_to_ellipsoid_f64[(2,2)] as f32, world_to_ellipsoid_f64[(2,3)] as f32,
            world_to_ellipsoid_f64[(3,0)] as f32, world_to_ellipsoid_f64[(3,1)] as f32, world_to_ellipsoid_f64[(3,2)] as f32, world_to_ellipsoid_f64[(3,3)] as f32,
        );
        ...
        for y in 0..height {
            for x in 0..width {
                ...
                if distance_squared <= 1.0 {
                    ...
                    buffer[pixel_idx + 1] = (color[1] as f32 * intensity * alpha as f32 / 255.0) as u8;
                    buffer[pixel_idx + 2] = (color[2] as f32 * intensity * alpha as f32 / 255.0) as u8;
    ...
    pub fn render_volume_slice(
        ...
        let max_radius = ellipsoid.radii.x.max(ellipsoid.radii.y).max(ellipsoid.radii.z) as f32 + padding;
        let volume_min = [
        ...
        for y in 0..height {
            for x in 0..width {
                ...
                let inside_volume = world_pos[0] >= volume_min[0] && world_pos[0] <= volume_max[0] &&
                                   world_pos[1] >= volume_min[1] && world_pos[1] <= volume_max[1] &&
                                   world_pos[2] >= volume_min[2] && world_pos[2] <= volume_max[2];
