...
use render_loop::{RenderLoopService, render_state::{RenderPassType, RenderPassConfig}};
...
fn test_max_layer_limit() {
    ...
    for i in 0..8 {
        service.add_render_layer(i as u32, 1.0, (0.0, 0.0, 1.0, 1.0))
