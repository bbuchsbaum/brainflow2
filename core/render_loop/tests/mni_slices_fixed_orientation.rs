...
async fn test_mni_brain_slices_fixed_orientation() {
    ...
    let rgba_data = service.render_to_buffer().expect("Failed to render axial");
    save_rgba_as_png(
        &rgba_data,
        render_size,
        render_size,
        &output_dir.join("axial_original.png"),
        false,
    )
    ...
    save_rgba_as_png(
        ...
        render_size,
        render_size,
        &output_dir.join("coronal_flipped.png"),
        true,
    )
    ...
    save_rgba_as_png(
        ...
        render_size,
        render_size,
        &output_dir.join("sagittal_flipped.png"),
        true,
    )
