...
impl TransformValidator {
    ...
    pub fn validate_world_point(
        ...
        let in_bounds = voxel.x >= 0.0
            && voxel.x < volume_dims[0] as f32
            && voxel.y >= 0.0
            && voxel.y < volume_dims[1] as f32
            && voxel.z >= 0.0
            && voxel.z < volume_dims[2] as f32;
...
mod tests {
    ...
    fn test_point_validation() {
        ...
        let validation =
            TransformValidator::validate_world_point(&far_point, &anat_tfm, [256, 256, 256]);
