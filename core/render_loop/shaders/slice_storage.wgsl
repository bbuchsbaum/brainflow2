// Storage buffer version of slice shader for dynamic layer support
// Supports unlimited layers using storage buffers instead of fixed-size uniform arrays
...
// Same structure as UBO version but in storage buffer
struct LayerData {
    ...
    threshold_mode : u32,              // offset 108, size 4 (0=range, 1=absolute, 2=above, 3=below)
...
struct LayerMetadata {
    active_count: u32,
    _padding: array<u32, 7>, // Pad to 32 bytes to match Rust struct
};
