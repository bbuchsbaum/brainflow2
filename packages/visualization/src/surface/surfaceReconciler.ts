...
function getSurfaceLayers(surface: SurfaceRenderable): SurfaceRenderableLayer[] {
...
export function isSurfaceGeometryChanged(
  previousSurface: SurfaceRenderable,
  nextSurface: SurfaceRenderable
): boolean {
  return (
